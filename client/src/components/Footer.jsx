...
const Footer = () => {
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/3">
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b norder-gray-500/30 text-gray-500">
        <div>
      ...
      <p className="py-4 texte-center text-sm md:text-base text-gray-500">
